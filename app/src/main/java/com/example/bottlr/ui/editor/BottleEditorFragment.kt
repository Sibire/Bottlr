package com.example.bottlr.ui.editor
...
class BottleEditorFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        photoPreview = view.findViewById(R.id.bottleimage)
        saveButton = view.findViewById(R.id.saveButton)
        addPhotoButton = view.findViewById(R.id.addPhoto)
    ...
    private fun populateFields(bottle: com.example.bottlr.data.local.entities.BottleEntity) {
